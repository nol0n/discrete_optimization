...
namespace obv
{
    ...
    */
    ...
    BigInt pow(const BigInt& base, int exp) {
        if (exp < 0) {
            ...
            return BigInt::abs(base) == 1 ? base : 0;
        }
        if (exp == 0) {
            if (base == 0)
    ...
    */
    ...
    BigInt sqrt(const BigInt& num) {
        ...
        while (BigInt::abs(sqrt_current - sqrt_prev) > 1) {
    ...
    */
    ...
    BigInt gcd(const BigInt &num1, const BigInt &num2){
        BigInt abs_num1 = BigInt::abs(num1);
        BigInt abs_num2 = BigInt::abs(num2);
    ...
    */
    ...
    BigInt lcm(const BigInt& num1, const BigInt& num2) {
        ...
        return BigInt::abs(num1 * num2) / gcd(num1, num2);
    }
